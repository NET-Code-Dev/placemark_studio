...
class CsvConverterViewModel extends BaseViewModel {
  ...
  Future<void> exportToKml() async {
    ...
    try {
      ...
      // Update generation options with current settings
  ...
  /// Validate coordinates and update state
  void _validateCoordinates() {
    ...
    try {
      ...
      // This will trigger coordinate validation in the CsvData model
      _csvData!.validateCoordinates(_columnMapping!);
